define([], function() {
  return {
		...
		Title: "Color Picker Sample",
		Message:
			"Welcome to the Color Picker Sample web part, following you can find the selected colors!",
		CannotSelectThisColorErrorMessage: "You cannot select this color!",
	};
});